...
export const addToHistory = async (itemId) =>
  requestUserData("PUT", `history/${itemId}`, true);

// This function will remove the requested item from the history.
...
export const getHistory = async () => requestUserData("GET", "history", true);
