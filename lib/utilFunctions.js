...
import { getFavourites, getSearchHistory } from "./userData";
...
export const requestUserData = async (
  ...
  let res = await requestUserDataResponse(
    httpReqType,
    route,
    authorization,
    bodyProperties
...
export const updateAtoms = async (setFavouriteList, setSearchHistory) => {
